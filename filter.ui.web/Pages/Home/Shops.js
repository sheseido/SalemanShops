angular.module('centerEndApp').controller('shopsCtrl', function ($scope, $http, $timeout, $ocLazyLoad, $element, NgTableParams, Upload, toaster) {
    $scope.pageBase = "Shops";
    $scope.pageTitle = "店铺";
    $scope.current = {};
    $scope.EditTitle = "";
    $scope.condition = {};
    ...
    $scope.tableParams = new NgTableParams({
        ...
        count: 10
            ...
            getData: function ($defer, params) {
                $scope.checkboxes = { 'checked': false, items: {} };
                $scope.doGet("/Shops/GetPagedShops?page=" + params.page() + "&size=" + params.count(), { params: $scope.condition }
                    , function (data) {
                        $timeout(function () {
